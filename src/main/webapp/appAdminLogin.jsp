    ...
    <div class="box">
        <div class="inner-box">
            <div class="forms-wrap">
                <form action="openpark?page=aprovAdminLogin" method="post"  class="sign-in-form">
                    ...
                    <div class="heading">
                        ...
                        <a href="openpark?page=adminLogin" class="toggle">Register</a>
                    </div>
                ...
                <form action="openpark?page=adminLogin" method="post" autocomplete="off" class="sign-up-form">
                    <div class="logo">
                        <img src="./assets/img/logo.png" alt="easyclass" />
                        <h4>openpark</h4>
                    </div>
